...
def run(
    ...
    project=ROOT / "runs6603/val",  # save to project/name
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/traffic6603.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "yolov5dt6603.pt", help="model path(s)")
    ...
    parser.add_argument("--project", default=ROOT / "runs6603/val", help="save to project/name")
